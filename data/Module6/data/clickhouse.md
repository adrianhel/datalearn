...
## 6.2.5 Движки таблиц
В **ClickHouse** используются различные движки таблиц, определяющие способы хранения, индексации и распределения данных.  
...
## 6.2.6 Физическая структура хранения
...
## 6.2.7 Партиционирование и сегментация
**ClickHouse** поддерживает партиционирование таблиц, позволяющее логически разбивать данные на независимые части 
...
## 6.2.8 Primary Key и индексирование
**Primary Key** в **CH** не обеспечивает уникальность строк. Используется для организации данных и ускорения поиска. 
Определяет порядок хранения строк внутри частей и создаёт _Sparse Index_ — разреженный индекс, который указывает 
на блоки данных.  
