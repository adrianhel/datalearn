...
В **ClickHouse** реализация [жизненного цикла данных](clickhouse/ch_lifecycle.md) оптимизирована для работы с большими объёмами информации 
и высокой скоростью аналитических запросов.  
