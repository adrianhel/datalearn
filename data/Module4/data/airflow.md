...
## 4.5.8 Сенсоры (Sensor Operators)
...
Интерфейс **Airflow** предназначен в первую очередь для просмотра состояния задач и логов. Помимо этого он 
