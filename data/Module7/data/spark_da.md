## 7.7.1 Преимущества Spark для аналитики
...
8. Расширяемость и открытая архитектура  
   - Открытый исходный код и активное сообщество способствуют быстрому развитию Spark и появлению новых библиотек и 
   инструментов.  
  
   - Поддержка пользовательских преобразований, пользовательских источников данных и расширения стандартных API.  

9. Экономическая эффективность  
   - Возможность использования стандартного оборудования (commodity hardware) и облачных платформ снижает затраты на 
   инфраструктуру.  
  
   - Высокая производительность и оптимизация ресурсов позволяют обрабатывать большие объёмы данных с минимальными 
   затратами времени и вычислительных ресурсов.  

## 7.7.2 Практические применения Spark в аналитике
