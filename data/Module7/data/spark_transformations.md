## 7.8.1 Преобразования (Transformations) в Apache Spark
...
## 7.8.2 Классификация трансформаций
...
## 7.8.3 Что происходит при вызове трансформации?
...
## 7.8.4 Основные трансформации и примеры
### map
...
## 7.8.5 Особенности и принципы трансформаций
