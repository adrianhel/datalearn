## 7.8.1 Действия (Actions) в Apache Spark
...
## 7.8.3 Что происходит при вызове действия?
Spark:
...
## 7.8.5 Принципы работы действий
...
## 7.8.6 Примеры практического применения
...
## 7.8.7 Подходы к оптимизации вычислений
