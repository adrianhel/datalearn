...
**Spark SQL** — компонент Apache Spark, предназначенный для обработки структурированных данных. Он предоставляет интерфейс 
для работы с данными в виде таблиц, поддерживает запросы на языке SQL, а также интеграцию с программными интерфейсами 
на языках Scala, Java, Python и R. Spark SQL оптимизирован для масштабируемой обработки больших объёмов данных 
и является основным инструментом для аналитики в рамках экосистемы Spark.  
