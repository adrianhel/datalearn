...
Несмотря на высокую производительность и широкие возможности, Spark обладает рядом ограничений и особенностей, 
критичных для проектирования и эксплуатации систем обработки данных.  