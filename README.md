...
_В модуле 4 нашей задачей является наполнение и автоматизация интеграции, и трансформации данных для нашего Хранилища 
данных, а также нам предстоит разобраться в чем отличие ETL от ELT, рассмотрим примеры популярных on-premise batch 
