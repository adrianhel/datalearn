...
отрисовкой модели данных в **SqlDBM** и последующим размещением в облаке._

#### [Модуль 3: Визуализация данных](DE-101/Module3/readme.md)
_В модуле 3 нашей задачей является создание отчетности и дашбордов, используя инструменты Business Intelligence 
для визуализации данных – **Tableau**, **Power BI**._