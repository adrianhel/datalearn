...
Для начала создадим схему superstore.
...
#### Создадим схему нашего Хранилища данных в **DBeaver**

```sql
CREATE SCHEMA dwh;
```
Используем сгенерированный код для создания нашего Хранилища данных и дополним его проверками, 
а также наполним данными из БД Superstore.
