...
[Краткое руководство](https://superset.apache.org/docs/quickstart/) поможет вам запустить его на локальном компьютере 
за 3 простых шага. Обратите внимание, у вас должны быть установлены **Docker**, **Docker Compose** и **Git**.
