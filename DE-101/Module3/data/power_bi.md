...
### Cards
В верхней части дашборда будут расположены карточки с ключевыми метриками: Sales, Profit, Discount, Quantity, Returned.

<img src="/DE-101/Module3/img/key_metrics_pbi.png" width="100%">