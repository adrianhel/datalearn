...
1. Скачаем файл _Superstore.xls_ через http протокол.
2. Объединим данные из разных листов в одну таблицу.
3. Подготовим исходные данные.
4. Сделаем общий job, который будет выполнять эти задачи по порядку.
5. Настроим выполнение job по расписанию через Планировщик задач.
