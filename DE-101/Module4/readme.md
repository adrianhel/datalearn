...
Для решения задач по созданию конвейера данных используем 
**[Pentaho Data Integration](https://community.pentaho.com/home)**. 

После скачивания и установки Pentaho, устанавливаем переменные среды (если работаем из-под Windows) и можно приступать
к работе.
